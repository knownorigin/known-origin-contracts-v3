...
contract('KODAV3GatedMarketplace tests...', function (accounts) {
    ...
    beforeEach(async () => {
        ...
        console.log('KODAV3GatedMarketplace deployed to:', this.basicGatedSale.address);
    ...
    describe.only('KODAV3GatedMarketplace v1', async () => {
    ...
    describe.only('KODAV3GatedMarketplace v2', async () => {

        describe('upgrade', async () => {

            it('can upgrade and see sale', async () => {

                const KODAV3GatedMarketplaceV2 = await ethers.getContractFactory('KODAV3GatedMarketplaceV2');
                console.log('Upgrading to KODAV3GatedMarketplaceV2...');

                await upgrades.upgradeProxy(this.basicGatedSale.address, KODAV3GatedMarketplaceV2);
                console.log('KODAV3GatedMarketplaceV2 upgraded');

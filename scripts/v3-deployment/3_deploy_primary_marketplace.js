...
async function main() {
  ...
  console.log('Deploying primary marketplace with the account:', await deployer.getAddress());
  ...
  const KODAV3Marketplace = await ethers.getContractFactory('KODAV3PrimaryMarketplace');
